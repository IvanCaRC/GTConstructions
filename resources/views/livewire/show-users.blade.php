    ...
    <div class="card-body p-3">
      <div class="mb-3">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control bg-light border-0 small" placeholder="Buscar a..." aria-label="Search" aria-describedby="basic-addon2" wire:model="search">
                              ...
                              <div class="card-body p-5">
                                  <div class="header mb-3">
                                      <h5 class="fw-normal mb-0">Registrar Usuario
                                          <img src="{{ asset('img/adduser.png') }}" alt="Agregar Usuario" class="img-fluid ml-2" style="width: 80px; height: auto;">
                                      </h5>
                                  </div>
                                  <form method="POST">
                                      @csrf
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" id="phoneInput" name="phone" required minlength="10" maxlength="10" pattern="[0-9]{10}" title="Debe contener exactamente 10 dígitos" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,10);">
                                      </div>
                                      <div class="mb-3">
